...
class Dtn_Weblog_Block_Adminhtml_Blogpost_Grid extends Mage_Adminhtml_Block_Widget_Grid{
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('blogpost_id',array(
            ...
            'align'=>'right',
            'width'=>'10px',
            'index'=>'blogpost_id'//lấy dữ liệu từ db trùng với tên cột
        ));
...
//        return parent::_prepareMassaction(); // TODO: Change the autogenerated stub
        $this->setMassactionIdField('blogpost_id');// Là cái id trong bảng db
        $this->getMassactionBlock()->setFormFieldName('blogpost');// trung với giá trị pram chuyền vào trong controller

        $this->getMassactionBlock()->addItem('delete',array(
            'label' => Mage::helper('weblog')->__('Delete'),
            'url'      => $this->getUrl('*/*/massDelete'),//trỏ đến hàm deleteAction trong controller
